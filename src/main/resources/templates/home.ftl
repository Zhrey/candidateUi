...
<script type="text/javascript">
    ...
    function shortcutsInit() {
        $.each(JSON.parse($.getCookie('list')), function (i, obj) {
            if (obj.perId === 'f00ffa189ae94c8288406639e489ac9d') {
                $('.wb-actions').append("<div class=\"col-sm-2\"><a href=\"newContract\">新建合同</a></div>")
            }
            if (obj.perId === '0148139134614a6782db3b84000cf974') {
                $('.wb-actions').append("<div class=\"col-sm-2\"><a href=\"company\">新建客户</a></div>")
            }
        });
    }
    function test(type){
