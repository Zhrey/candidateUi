...
<script type="text/javascript" src="js/history.js?${.now?string["MMddhhmmSSsss"]}"></script>
<script type="text/javascript" src="js/common/header.js?${.now?string["MMddhhmmSSsss"]}"></script>
